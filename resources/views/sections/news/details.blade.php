...
<div id="lqd-contents-wrap">
    ...
    <article class="lqd-post-content pos-rel post-3440 post type-post status-publish format-standard has-post-thumbnail hentry category-modern" id="post-3440" itemscope="itemscope" itemtype="http://schema.org/BlogPosting">
        <div class="entry-content lqd-single-post-content clearfix">
            ...
            <h1 class="entry-title">Free advertising for your business</h1>
            <div class="entry-meta d-flex flex-wrap align-items-center text-center text-md-left">
                <div class="byline">
                    <span class="d-flex flex-column"> <span>Author</span> <span class="entry-author" itemscope="itemscope" itemtype="http://schema.org/Person"> <span itemprop="name"> <a class="url fn">Philip Reyes</a> </span> </span>
                    </span>
                </div>
                <div class="posted-on"> <span>Published on:</span> <a> <time class="entry-date published" datetime="2018-08-16T11:32:32+00:00">August 16,
                            2018</time> </a> </div>
                <div class="cat-links"> <span>Published in:</span> <a>Blog</a> </div>
            </div>
        </div>
                                            
                                            <p>You want to succeed,
                                                surround yourself with the right kind of people who will support and
                                                encourage you all the way. Be with people who have utmost conviction
                                                and patience. The battle is never lost until you’ve abandon your
                                                vision. But what if you’re really exhausted physically,
                                                mentally,
                                                and most of all emotionally? Here are some to prompt you in reaching the peak of
                                                accomplishment. You want to succeed,
                                                surround yourself with the right kind of people who will support and
                                                encourage you all the way. Be with people who have utmost conviction
                                                and patience. The battle is never lost until you’ve abandon your
                                                vision. But what if you’re really exhausted physically,
        ...
        <footer class="blog-post-footer entry-footer">
            <nav class="post-nav align-items-center h5">
                ...
                <div class="nav-next"> <a href="https://asymmetric-agencypro.liquid-themes.com/investment-trend-monitor-top-trends-in-2021/" rel="next"> <span class="screen-reader-text">Next Article</span> <span aria-hidden="true" class="nav-subtitle"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" stroke="#444" stroke-width="2" x="0px" y="0px" viewBox="0 0 24 24" xml:space="preserve" width="24" height="24">
                            ...
                            </svg> Next Article </span> <span class="nav-title">Investment trend monitor: Top
                            trends in 2021</span> </a> </div>
            </nav>
        </footer>
    </article>
