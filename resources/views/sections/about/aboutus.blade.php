        ...
        <div class="row">
            <div class="col col-md-6 col-lg-6 col-12">
                <div class="iconbox mb-30 flex flex-col relative justify-center items-start text-start animation-element lqd-unit-animation-done" style="">
                    <div class="iconbox-icon-wrap"><span class="iconbox-icon-container mb-30 text-50 leading-1em text-primary transition-all"><i class="lqd-icn-ess icon-lqd-mobile"></i></span></div>
                    <div class="contents">
