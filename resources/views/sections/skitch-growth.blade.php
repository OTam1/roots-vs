<div class="sf-container">
    <div>
        <h1 class="sf-title">From a Skitch To Growth</h1>
        <div class="flex-container">
            <div class="flex-item item1">
                <p class="step_sf">STEP 1</p>
            ...
            <div class="flex-item item3">
                <p class="step_sf">STEP 3</p>
                <h1 class="title_sf">Creation</h1>
                <p class="para_sf">Every venutre is co-founded alongside impact driven entrepreneurs,
                    our role Involves technical
                    development, administrative setup, funding and fundraising, and capability building.

                </p>
            </div>

            <div class="flex-item item4">
                <p class="step_sf">STEP 4</p>
                <h1 class="title_sf">Growth</h1>
